...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *accoona.io.preeval*):

Restore dependencies
```
    cd "accoona.io.preeval"
    dotnet restore
```

Execute unit tests
```
    cd "accoona.io.preeval/test/accoona.io.preeval.Tests"
    dotnet test
```

Deploy application
```
    cd "accoona.io.preeval/src/accoona.io.preeval"
