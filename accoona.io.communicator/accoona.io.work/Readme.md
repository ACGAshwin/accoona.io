...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *accoona.io.work*):
...
Execute unit tests
```
    cd "accoona.io.work/test/accoona.io.work.Tests"
    dotnet test
```

Deploy application
```
    cd "accoona.io.work/src/accoona.io.work"
