...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *accoona.io.communicator*):

Restore dependencies
```
    cd "accoona.io.communicator"
    dotnet restore
```

Execute unit tests
```
    cd "accoona.io.communicator/test/accoona.io.communicator.Tests"
    dotnet test
```

Deploy application
```
    cd "accoona.io.communicator/src/accoona.io.communicator"
